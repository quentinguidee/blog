...
export default function Episode4() {
    return (
        <Article author="Quentin Guidée" date="18/05/2021">
            <Title title="épisode 4" subtitle="Accéléromètre et gyroscope" />
            <Background image={MPU} noCredits />
            <Subtitle text="Intro" />
            <Text>
                Dans cet épisode, on va enfin s'atteler à une des parties les
                plus intéressantes des drones : leur stabilisation. Mais vous
                concevez qu'on est face à un problème majeur ! Si on bouge le
                drone, nous on sait qu'on l'a bougé. Lui pas...
            </Text>
            <Text>
            ...
            <Text>
                <ul>
                    ...
                    <li>
                        ...
                        connaitre la vitesse angulaire du drone en tout temps
                        (exprimée en <InlineMath>deg/s</InlineMath>).
                    </li>
                </ul>
            </Text>
            <Subtitle text="Le MPU-9250" />
            <Text>
                Pour notre drone, nous utiliserons un Groove MPU-9250. En plus
                de disposer d'un accéléromètre et d'un gyroscope, il est aussi
                doté d'un magnétomètre dont nous pourrions nous servir plus
                tard.
            </Text>
            <Image height={400} src={MPU} alt="mpu-9250" />
            <Text>
            ...
            <Text>
                ...
                <Definition>MPU9250_asukiaaa</Definition> afin de communiquer
                avec ce composant depuis le code. Mais attention, la librairie
                ne va faire que lire les données brutes du capteur. Des maths
                resteront à faire !
            </Text>
            <Subtitle text="L'accéléromètre" />
            <Text>
                Dans un premier temps, on va essayer de calculer l'accélération
                du drone. On va donc utiliser l'accéléromètre. Récupérons ses
                données brutes grâce à la librairie :
            </Text>
            <Code
                code={
            ...
            <Text>
                ...
                plat, et si on affiche les accélérations dans la console, on va
                voir un résultat relativement inattendu :
            </Text>
            <BlockMath>
                {
            ...
            <Text>
                ...
                <InlineMath>0</InlineMath> car il n'accélère pas dans le sens
                des X.
            </Text>
            <Text>
                Remarque : le <InlineMath>1</InlineMath> pour la composante Z
                est tout à fait normal. C'est la gravité.
            </Text>
            <Text>
                Il faudra donc calibrer le MPU-9250 à{" "}
                <InlineMath>(0,0,1)</InlineMath> au démarrage du drone ! C'est
                une étape très importante, sinon le drone volera difficilement
                droit !
            </Text>
            <Text>
                Personnellement, pour calibrer l'accéléromètre, je prend 100
                mesures espacées de 10 millisecondes au démarrage du drone. La
                médiane de ces mesures triées détermine l'erreur "moyenne" du
                capteur.
            </Text>
            <Text>
                Le processus de calibration prendra donc 1 seconde à chaque
                allumage du drone (car <InlineMath>100\cdot 10ms</InlineMath>
            ...
            <Text>
                ...
                calibration. On utilisera exactement la même méthode que celle
                utilisée pour l'accéléromètre.
            </Text>
            <Text>
            ...
            <Text>
                ...
                composante X de la rotation. Si le drone fait une rotation de{" "}
                <InlineMath>5deg/s</InlineMath> pendant 2 secondes, il a une
                inclinaison finale de <InlineMath>10 deg</InlineMath>, car
            </Text>
            <BlockMath>2s\cdot 5 deg/s = 10 deg</BlockMath>
            <Text>
                Après ça, s'il s'incline encore de{" "}
                <InlineMath>3 deg/s</InlineMath> pendant 1 seconde, il va former
                un angle de <InlineMath>13 deg</InlineMath>, car
            </Text>
            <BlockMath>10deg + 1s\cdot 3 deg/s = 13 deg</BlockMath>
            <Text>
                On finit par deviner que, pour calculer l'angle du drone, il
                faudra rafraîchir en boucle son angle avec quelque chose comme
                ça :
            </Text>
            <BlockMath>
            ...
            <Text>
                ...
                écoulé entre la dernière mesure et la mesure actuelle. En C++,
                ça donnera :
            </Text>
            <Code
                code={
            ...
            />
            <Text>
                Hélas, ce n'est pas aussi simple :/ On va encore faire face à
                une imprécision... Le gyroscope est très bon pour calculer
            ...
            <Text>
                On n'avait pas dit que l'accéléromètre permettait de déterminer
                son accélération, et le gyroscope sa vitesse angulaire ?
            </Text>
            <Text>
            ...
            <Image height={220} src={DroneGravity} alt="Drone gravity schema" />
            <Text>
                Vous voyez peut-être où je veux en venir. Même si le drone ne
                bouge pas, la composante d'accélération en Z prend en compte la
                gravité !
            </Text>
            <Text>Maintenant, si on représente le drone incliné :</Text>
            <Image
                height={250}
                src={DroneGravityTurn}
                alt="Drone gravity turn schema"
            />
            <Text>
                La gravité s'est répartie sur deux axes ! On peut donc utiliser
                ce phénomène pour connaître notre inclinaison.
            </Text>
            ...
            <Text>
                Maintenant, on peut donc effectuer une correction des valeurs :
            </Text>
            <Code
                code={
            ...
            />
            <Text>
                Ce qu'on a fait ici, c'est prendre 99,5% de l'angle calculé par
                le gyroscope (précis à court terme), et le corriger au fur et à
                mesure par 0,05% de l'angle déterminé grâce à la gravité
                terrestre.
            </Text>
            <Subtitle text="Essai avec un Servo" />
            <Text>
                Après avoir affiché les valeurs de l'accéléromètre et du
                gyroscope dans la console pour m'assurer que tout fonctionne,
                j'ai voulu tester la réactivité des capteurs et du programme. Il
                y avait plusieurs manières de tester ça, mais pour s'amuser,
                j'ai choisi de brancher un servo. C'est un moteur qui tourne de
                0 à 180°.
            </Text>
            <Text>
                J'ai fait en sorte que le moteur décrive le même angle que celui
                de l'axe X du drone.
            </Text>
            ...
            <Text>
                <ul>
                    <li>
                        Les accélérations{" "}
                        <InlineMath>(acc_x, acc_y, acc_z)</InlineMath> grâce à
                        l'accéléromètre
                    </li>
                    <li>
                    ...
                    <li>
                        Les angles{" "}
                        <InlineMath>(\alpha_x, \alpha_y, \alpha_z)</InlineMath>{" "}
